...
SETTINGS = {
    'query_api': os.getenv('QUERY_API',
                           'http://svip.kuaidaili.com/api/getproxy/?orderid=941375378355487&num=1000&b_pcchrome=1&b_pcie=1&b_pcff=1&protocol=2&method=2&an_ha=1&sp1=1&sort=2&sep=2'),
    'redis_key': os.getenv('REDIS_KEY', 'ip_list'),
    'max_size': os.getenv('MAX_SIZE', 5000),
    'expire_time': os.getenv('EXPIRE_TIME', 0),
    'redis_host': os.getenv('REDIS_HOST', '127.0.0.1'),
    'redis_port': os.getenv('REDIS_PORT', 6379),
    'time_div': os.getenv('TIME_DIV', 30),
    'max_retry': os.getenv('MAX_RETRY', 100),
}
